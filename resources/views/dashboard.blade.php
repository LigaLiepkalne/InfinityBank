            ...
            <div class="row d-flex justify-content-center md:border-t-0">
                ...
                <div class="col-md-6 col-lg-3 text-center">
                    <h4 class="h1 font-weight-bold mb-3">
                        ...
                        <span class="d-inline-block count-up" data-from="0" data-to="100" data-time="2000">{{ number_format($totalBalance8, 2) }}</span>
                    </h4>
                ...
                <div class="col-md-6 col-lg-3 mb-4 text-center">
                    <h4 class="h1 font-weight-bold mb-3">
                        ...
                        <span class="d-inline-block count1" data-from="0" data-to="250" data-time="2000">{{$userAccountCount}}</span>
                    </h4>
                ...
                <div class="col-md-6 col-lg-3 mb-4 text-center">
                    <h4 class="h1 font-weight-bold mb-3">
                        ...
                        <span class="d-inline-block count2" data-from="0" data-to="330" data-time="2000">{{$userAccountCurrencyCount}}</span>
                    </h4>
            ...
            @foreach ($userBankAccounts as $account)
                <div class="col-md-3 mb-4">
                    <label>
                        ...
                        <div class="card card-input" onclick="location.href='accounts/{{ $account->id }}'" style="cursor:pointer;">
                            <div class="card-body">
